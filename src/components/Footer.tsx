...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#171717] border-t border-[#262626] py-12">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            ...
            <p className="mt-4 text-gray-400 max-w-md">
              I'm Abdellah Raissouni, an engineering student and web developer specializing in creating 
              impressive, modern web experiences that convert visitors into clients.
            </p>
        ...
        <div className="mt-12 pt-8 border-t border-[#262626] flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">
            © {currentYear} Abdellah Raissouni. All rights reserved.
          </p>
        ...
        >
          <Link 
            href="#home"
            className="w-12 h-12 bg-[#3b82f6] rounded-full flex items-center justify-center shadow-lg hover:bg-[#10b981] transition-colors duration-300"
